...
\begin{Enumerate}
	...
	\item \makebox[9.47\zw][l]{{\tt ipsjtech.sty}}: 研究報告用スタイル
...
各種別は
\begin{itemize}
	\item \makebox[9.\zw][l]{指定なし}論文

	      \| |Regular Paper

	\item \makebox[9.\zw][l]{{\tt Short}}ショートペーパー
...
Trans.\ Bioinformatics (TBIO)は英文論文誌であるので，\|TBIO|オプションの 指定によって自動的に\|english|オプションが指定されたものとみなされ， \|english| オプションの省略が可能．

論文種別は以下の3種．
\begin{itemize}
	\item \makebox[4.\zw][l]{指定なし} Original Paper (Default)
...
論文種別は4種類あり，
\begin{itemize}
	\item \makebox[4.\zw][l]{指定なし} Regular Paper (Default)
